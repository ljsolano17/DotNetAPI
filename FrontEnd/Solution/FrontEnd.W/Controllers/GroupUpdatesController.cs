...
namespace FrontEnd.W.Controllers
{
    public class GroupUpdatesController : Controller
    {
        ...
        {
              return _context.GroupUpdates != null ? 
                          View(await _context.GroupUpdates.ToListAsync()) :
                          Problem("Entity set 'SocialGoalContext.GroupUpdates'  is null.");
        }

        // GET: GroupUpdates/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null || _context.GroupUpdates == null)
            {
                return NotFound();
            }
